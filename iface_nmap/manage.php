...
This is a command line PHP script to manage nmap scans locally.

  Usage:
  <?php echo $argv[0]; ?> <option>

  <option> can be one of the options below.
        scan [host]             scans a specified host
        list                    lists pid's of all scans
        status [pid]            checks status of pid
        killall                 kills all nmap scans
